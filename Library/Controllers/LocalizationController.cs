    ...
    public class LocalizationController : ControllerBase
    {
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ["SK"] = new Dictionary<string, string>
            {
                ...
                ["admin.searchPlaceholder"] = "Vyhľadať knihy podľa názvu, autora, žánru...",
                ["admin.selectAuthorPlaceholder"] = "Vyberte autora...",
                ["admin.filterAuthorsPlaceholder"] = "Hľadať autora...",
                ["admin.noAuthorsFound"] = "Nenašli sa žiadni autori",
                ["admin.validationAuthorRequired"] = "Meno, priezvisko a krajina autora sú povinné.",
                ["admin.addAuthorBtn"] = "Nový",
                ["admin.createAuthorBtn"] = "Vytvoriť",
                ["admin.authorNameLabel"] = "Meno *",
                ["admin.authorSurnameLabel"] = "Priezvisko *",
                ["admin.authorCountryLabel"] = "Krajina *",
                ["admin.selectCountryPlaceholder"] = "Vyberte krajinu...",
                ...
                ["details.submit"] = "Pridať",
                ["details.submitting"] = "Odosielam...",
                ["details.validation_empty_review"] = "Text recenzie je povinný.",
                ["details.submit_failed"] = "Nepodarilo sa odoslať recenziu",
                ["details.delete_failed"] = "Nepodarilo sa vymazať recenziu",
                ["pagination.prev"] = "Predchádzajúca",
                ["pagination.next"] = "Nasledujúca",
                ["books.sort.label"] = "Zoradiť podľa:",
                ["books.sort.popularity"] = "Popularity",
                ["books.sort.rating"] = "Celkového hodnotenia",
                ["books.sort.positivereviews"] = "Kladných recenzií",
                ["books.sort.negativereviews"] = "Záporných recenzií",
                ["books.sort.published"] = "Dátumu vydania",
                ["books.sort.pages"] = "Počtu strán",
                ["books.sort.alphabetical"] = "Abecedne (A-Z)"
            },
            ["EN"] = new Dictionary<string, string>
            {
                ...
                ["admin.searchPlaceholder"] = "Search books by title, author, genre...",
                ["admin.selectAuthorPlaceholder"] = "Select author...",
                ["admin.filterAuthorsPlaceholder"] = "Filter authors...",
                ["admin.noAuthorsFound"] = "No authors found",
                ["admin.validationAuthorRequired"] = "Author name, surname and country are required.",
                ["admin.addAuthorBtn"] = "New",
                ["admin.createAuthorBtn"] = "Create",
                ["admin.authorNameLabel"] = "First Name *",
                ["admin.authorSurnameLabel"] = "Last Name *",
                ["admin.authorCountryLabel"] = "Country *",
                ["admin.selectCountryPlaceholder"] = "Select country...",
                ...
                ["details.validation_empty_review"] = "Review text is required.",
                ["details.submit_failed"] = "Failed to submit review",
                ["details.delete_failed"] = "Failed to delete review",
                ["pagination.prev"] = "Previous",
                ["pagination.next"] = "Next",
                ["books.sort.label"] = "Sort by:",
                ["books.sort.popularity"] = "Popularity",
                ["books.sort.rating"] = "Rating",
                ["books.sort.positivereviews"] = "Positive reviews",
                ["books.sort.negativereviews"] = "Negative reviews",
                ["books.sort.published"] = "Published date",
                ["books.sort.pages"] = "Page count",
                ["books.sort.alphabetical"] = "Alphabetical (A-Z)"
            },
            ["GR"] = new Dictionary<string, string>
            {
                ...
                ["admin.searchPlaceholder"] = "Αναζήτηση βιβλίων κατά τίτλο, συγγραφέα, κατηγορία...",
                ["admin.selectAuthorPlaceholder"] = "Επιλέξτε συγγραφέα...",
                ["admin.filterAuthorsPlaceholder"] = "Φιλτράρισμα συγγραφέων...",
                ["admin.noAuthorsFound"] = "Δεν βρέθηκαν συγγραφείς",
                ["admin.validationAuthorRequired"] = "Το όνομα, το επώνυμο και η χώρα του συγγραφέα είναι υποχρεωτικά.",
                ["admin.addAuthorBtn"] = "Νέος",
                ["admin.createAuthorBtn"] = "Δημιουργία",
                ["admin.authorNameLabel"] = "Όνομα *",
                ["admin.authorSurnameLabel"] = "Επώνυμο *",
                ["admin.authorCountryLabel"] = "Χώρα *",
                ["admin.selectCountryPlaceholder"] = "Επιλέξτε χώρα...",
                ...
                ["details.submit"] = "Προσθήκη",
                ["details.submitting"] = "Υποβολή...",
                ["details.validation_empty_review"] = "Το κείμενο της κριτικής είναι υποχρεωτικό.",
                ["details.submit_failed"] = "Αποτυχία υποβολής κριτικής",
                ["details.delete_failed"] = "Αποτυχία διαγραφής κριτικής",
                ["pagination.prev"] = "Προηγούμενη",
                ["pagination.next"] = "Επόμενη",
                ["books.sort.label"] = "Ταξινόμηση κατά:",
                ["books.sort.popularity"] = "Δημοτικότητα",
                ["books.sort.rating"] = "Βαθμολογία",
                ["books.sort.positivereviews"] = "Θετικές κριτικές",
                ["books.sort.negativereviews"] = "Αρνητικές κριτικές",
                ["books.sort.published"] = "Ημερομηνία κυκλοφορίας",
                ["books.sort.pages"] = "Αριθμός σελίδων",
                ["books.sort.alphabetical"] = "Αλφαβητικά (Α-Ω)"
            }
        };
